...
const conferenceData = {
	organization: 'IPN',
	title: 'Arte y conocimiento',
	subtitle: 'De la poesía, al jazz y... al ¡autocinema!',
	location: 'Auditorio Ing. Manuel Moreno Torres',
	date: 'Nov 28, 2024',
	time: '14:00 - 18:00 hrs',
	image: '/ipnlogo.png',
};

export const Conferenciaarte = (): JSX.Element => {
	return (
